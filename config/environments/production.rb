Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://evercell.vercel.app/', /https:\/\/evercell.vercel.app*/ ]
  ...
  # config.active_job.queue_name_prefix = "evercell-backend_#{Rails.env}"
